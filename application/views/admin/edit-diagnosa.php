                    ...
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form method="post" action="">
                                <input type="hidden" value="<?= $diagnosaById->id; ?>" name="id">
                                <div class="form-group">
                                    <label for="kode_diagnosa">Kode diagnosa</label>
                                    <input type="text" class="form-control input-default" name="kode_diagnosa" value="<?= $diagnosaById->kode_diagnosa; ?>">
                                    <small class="form-text text-danger"><?= form_error('kode_diagnosa'); ?></small>
                                </div>
                                <div class="form-group">
                                    <label for="nama_diagnosa">Nama diagnosa</label>
                                    <input type="text" class="form-control input-default" name="nama_diagnosa" value="<?= $diagnosaById->nama_diagnosa; ?>">
