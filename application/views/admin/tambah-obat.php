                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form method="post" action="<?= base_url('admin/obat/tambahObat'); ?>">
                                <!-- <input type="hidden" value="<?= $sub['id']; ?>" name="id"> -->
                                <div class="form-group">
                                    <label for="kode_diagnosa">Kode obat</label>
                                    <input type="text" class="form-control input-default" name="kode_obat">
                                    <small class="form-text text-danger"><?= form_error('kode_obat'); ?></small>
                                </div>
                                <div class="form-group">
                                    <label for="nama_obat">Nama obat</label>
                                    <input type="text" class="form-control input-default" name="nama_obat">
